...
model.add(layers.ConvLSTM2D(filters=64, kernel_size=(1, 5), input_shape=(1, 1, X_train.shape[3], 1), return_sequences=True))
model.add(layers.BatchNormalization())
model.add(layers.ConvLSTM2D(filters=64, kernel_size=(1, 5)))
model.add(layers.BatchNormalization())
...
with open("modeltest13,1.json", "w") as json_file:
    json_file.write(model_json)

# Simpan bobot model ke file H5
model.save_weights("modeltest13,1.weights.h5")
